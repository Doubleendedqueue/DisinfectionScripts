...
call :deleteDirectory "%PROGRAMFILES%\LenovoBrowserGuard"
call :deleteDirectory "%SYSTEMDRIVE%\Progra~2\LenovoBrowserGuard"
call :deleteDirectory "%PROGRAMFILES%\ORBTR"
call :deleteDirectory "%SYSTEMDRIVE%\Progra~2\ORBTR"
